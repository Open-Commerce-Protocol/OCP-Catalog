...
- 受控 transform rule
例如：
- ocp.talent.education.v1 可由 ext.pageflux.education.v1 映射满足
...
- rejected_missing_required：缺少必需 Pack 或字段
...
下面给一个简化示例。
{
  ...
  "target_object_type": "talent_profile",
  "required_packs": [
    "ocp.talent.resume.v1"
  ],
  "optional_packs": [
    ...
    "ocp.talent.age.v1",
    "ocp.talent.location.v1",
    "ocp.talent.availability.v1"
  ],
  "compatible_alternatives": {
    "ocp.talent.education.v1": [
      "ext.pageflux.education.v1"
    ]
  },
  "field_requirements": {
    "ocp.talent.resume.v1": {
      "required_fields": ["text", "skills"]
    },
    "ocp.talent.education.v1": {
      "required_fields": []
    }
