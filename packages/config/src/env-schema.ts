...
export const envSchema = z.object({
  ...
  CATALOG_QUEUE_CLEANUP_ENABLED: z.coerce.boolean().default(true),
  ...
  CATALOG_EMBEDDING_BATCH_WORKER_ENABLED: z.coerce.boolean().default(false),
  ...
  CATALOG_PROVIDER_THROTTLE_ENABLED: z.coerce.boolean().default(true),
