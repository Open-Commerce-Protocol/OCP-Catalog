...
This package is not the OCP Catalog Registration / Catalog Registry implementation. It implements the `Provider -> Catalog Node` side of the protocol. The `Catalog Node -> OCP Catalog Registration` handshake is documented in `docs/specs/registration/v1.md`.
