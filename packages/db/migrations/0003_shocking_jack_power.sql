...
CREATE INDEX "shopify_app_webhook_events_shop_topic_idx" ON "shopify_app_webhook_events" USING btree ("shop_domain","topic");--> statement-breakpoint
...
CREATE INDEX "shopify_app_sync_jobs_shop_domain_idx" ON "shopify_app_sync_jobs" USING btree ("shop_domain");
