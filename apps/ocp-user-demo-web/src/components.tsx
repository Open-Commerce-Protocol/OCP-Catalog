...
export function Metric({ label, value, note, delay = 0 }: { label: string; value: ReactNode; note?: string; delay?: number }) {
  return (
    <motion.div 
          ...
          <Dialog.Portal forceMount>
            ...
            <Dialog.Content asChild>
              <motion.div
                ...
                className="fixed left-1/2 top-1/2 z-50 max-h-[90vh] w-[min(92vw,800px)] overflow-y-auto rounded-2xl border border-ink/10 bg-white/95 p-8 shadow-[0_30px_100px_-20px_rgba(0,0,0,0.15)] ring-1 ring-inset ring-white/50 backdrop-blur-2xl outline-none"
              >
