...
function config(overrides: Partial<AppConfig>): AppConfig {
  return {
    ...
    CATALOG_SEARCH_INDEX_WORKER_CONCURRENCY: 16,
    ...
    CATALOG_QUEUE_CLEANUP_ENABLED: true,
    CATALOG_QUEUE_COMPLETED_RETENTION_DAYS: 7,
    CATALOG_QUEUE_CLEANUP_BATCH_SIZE: 1000,
    CATALOG_EMBEDDING_BATCH_WORKER_ENABLED: false,
    CATALOG_EMBEDDING_BATCH_WORKER_SUBMIT_LIMIT: 5000,
    CATALOG_EMBEDDING_BATCH_WORKER_INGEST_LIMIT: 5000,
    CATALOG_EMBEDDING_BATCH_MAX_ACTIVE_JOBS: 2,
    CATALOG_PROVIDER_THROTTLE_ENABLED: true,
    CATALOG_PROVIDER_THROTTLE_PENDING_JOB_LIMIT: 50000,
    CATALOG_PROVIDER_THROTTLE_RUNNING_JOB_LIMIT: 5000,
    CATALOG_PROVIDER_THROTTLE_FAILED_JOB_LIMIT: 10000,
    QUERY_EMBEDDING_CACHE_REDIS_URL: '',
    QUERY_EMBEDDING_CACHE_TTL_SECONDS: 600,
    QUERY_EMBEDDING_CACHE_MAX_ENTRIES: 5000,
